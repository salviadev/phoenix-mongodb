...
function importCollectionFromStream(db, schema, stream, options, tenantId) {
    return __awaiter(this, void 0, Promise, function* () {
...
function importCollectionFromFile(db, schema, file, options, tenantId) {
    return __awaiter(this, void 0, Promise, function* () {
        let collections = yield dbSchema.db.getCollections(db);
        let names = collections.map(collection => {
            return collection.collectionName;
        ...
        yield mongodbImport.importCollectionFromFile(collection, schema, file, options, tenantId);
    });
}
