...
function importCollectionFromStream(db, schema, stream, insertMode, tenantId) {
    return __awaiter(this, void 0, Promise, function* () {
        ...
        yield mongodbImport.importCollectionFromStream(collection, schema, stream, insertMode, tenantId);
    });
}
exports.importCollectionFromStream = importCollectionFromStream;
function importCollectionFromFile(db, schema, file, insertMode, tenantId) {
    return __awaiter(this, void 0, Promise, function* () {
        let collections = yield dbSchema.db.getCollections(db);
        let names = collections.map(collection => {
            return collection.collectionName;
        ...
        yield mongodbImport.importCollectionFromFile(collection, schema, file, insertMode, tenantId);
    });
}
