...
function importCollectionFromStream(collection, schema, stream, override, tenantId) {
...
function importCollectionFromFile(collection, schema, file, override, tenantId) {
